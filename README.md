...
![Pass vs Fail](outputs/graphs/pass_fail.png)

### Grade Distribution
![Grade Distribution](outputs/graphs/grade_distribution.png)

### Subject-wise Pass / Fail
![Subject Pass Fail](outputs/graphs/subject_pass_fail.png)

### Average Marks Distribution
![Average Distribution](outputs/graphs/average_distribution.png)
